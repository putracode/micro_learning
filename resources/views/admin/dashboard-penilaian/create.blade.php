...
<div class="col-12 grid-margin stretch-card pt-3">
    <div class="card">
        <div class="card-header py-3">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Tambah Embed</h6>
        </div>
        <div class="card-body">

            <form class="forms-sample" action="/admin/dashboard-penilaian" method="POST">

                @csrf

                <div class="mb-4">
                    <label for="embed" class="form-label">Embed</label>
                    <input type="text" class="form-control @error('embed') @enderror" id="embed" name="embed" required>
                    @error('embed')
