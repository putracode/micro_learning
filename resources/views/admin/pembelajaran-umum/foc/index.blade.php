    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title fw-bold">FOC</h3>
                <a href="/admin/p/foc/create" class="btn btn-primary btn-sm float-right px-4">Create</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/p/foc/{{ $row->id }}/edit">
                                ...
                                <a href="#" onclick="buttonConfirm({{ $row->id }})" data-name="p/foc" id="confirmbutton">
