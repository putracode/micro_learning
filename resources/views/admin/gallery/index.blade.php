    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title fw-bold">Gallery</h3>
                <a href="/admin/gallery/create" class="btn btn-primary btn-sm float-right px-4">Create</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/gallery/{{ $row->id }}" class="btn btn-danger btn-sm">Delete</a> --}}
                                <a href="/admin/gallery/{{ $row->id }}/edit">
                                    <button type="button" class="btn btn-icon  btn-warning mb-1">
