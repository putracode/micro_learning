...
<div class="card p-4">
    <div class=" d-flex justify-content-between align-items-center pb-3">
        <h5 class="p-0 m-0">List Pembelajaran</h5>
        <a href="/admin/list-pembelajaran/create" class="btn-sm btn-primary float-end px-4 ">Create</a>
    </div>
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" onclick="buttonConfirm({{ $row->id }})" data-name="list-pembelajaran"
                            id="confirmbutton">
