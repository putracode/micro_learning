...
<h4 class="fw-bold py-1 mb-4"><span class="text-muted fw-light">Edit/</span>List Pembelajaran</h4>

<div class="row">
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                <form action="/admin/list-pembelajaran/{{ $list->id }}" method="POST">
                    @csrf
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="/admin/list-pembelajaran" class="btn btn-danger px-4 me-2 float-end btn-sm">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
