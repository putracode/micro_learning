...
<div class="col-12 grid-margin stretch-card pt-3">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="/admin/p/pemeliharaan/{{ $post->id }}" method="POST">
                ...
                <a href="/admin/p/pemeliharaan" class="btn btn-danger px-5 mr-2 float-right">Cancel</a>
            </form>
        </div>
    </div>
</div>
