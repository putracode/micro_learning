...
<h4 class="fw-bold py-1 mb-4"><span class="text-muted fw-light">Edit/</span> Pembelajaran Aklik</h4>

<div class="row">
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-body">
                <form action="/admin/p/aklik/{{ $pembelajaran->id }}" method="POST">
                    @csrf
                    <input type="hidden" name="materi" value="Bidang Aktivasi Publik">
                    <div class="row mb-4">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="/admin/p/aklik" class="btn btn-danger px-5 me-2 float-end btn-sm">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
