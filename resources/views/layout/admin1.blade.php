            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class='sidebar-title m-0'>Admin Menu</li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li>
                                    <a href="/admin/p/aklik">Bidang Aktivasi Publik (AKLIK)</a>
                                </li>
                                <li>
                                    <a href="/admin/p/aklis">Bidang Aktivasi Listrik (AKLIS)</a>
                                </li>
                                <li>
                                    <a href="/admin/p/NA3P">Bidang NA3P</a>
                                </li>
                                <li>
                                    <a href="/admin/p/pemeliharaan">Bidang Pemeliharaan</a>
                                </li>
                                <li>
                                    <a href="/admin/p/retail">Bidang Retail</a>
                                </li>
                                <li>
                                    <a href="/admin/p/SPAP">Bidang SPAP</a>
                                </li>
                                <li>
                                    <a href="/admin/p/sarju">Bidang Sarju</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a class="dropdown-item" href="/home"><i data-feather="home"
                                        class="mr-1"></i>Homepage</a>
