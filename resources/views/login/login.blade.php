            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/" method="POST">
                ...
                <div class="mb-4">
                  ...
                  <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Enter your email" autofocus name="email" required value="{{ old('email') }}" autocomplete="off"/>
                  @error('email')
