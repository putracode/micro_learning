        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="/change-password" method="POST">
                @csrf
                <div class="mb-3 form-password-toggle">
                    ...
                    <div class="input-group input-group-merge">
                      <input type="password" id="current_password" class="form-control @error('current_password') is-invalid @enderror" name="current_password" required value="{{ old('current_password') }}" autocomplete="off" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="current_password" />
